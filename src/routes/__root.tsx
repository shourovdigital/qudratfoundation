...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "A transparency-first Bangladeshi foundation building sustainable futures through live-tracked social projects, direct community action, and volunteer-led impact." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Qudrat Foundation — Empowering Bangladesh" },
      { name: "twitter:description", content: "A transparency-first Bangladeshi foundation building sustainable futures through live-tracked social projects, direct community action, and volunteer-led impact." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/d7956d36-f2f0-4bf2-92cc-68bcde3865ac" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/d7956d36-f2f0-4bf2-92cc-68bcde3865ac" },
    ],
    links: [
